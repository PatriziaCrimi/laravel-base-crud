...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // Using global.$ will make the jquery object($) available
...
$(document).ready(function () {
  ...
  $('#new-bouquet-form').on('submit', function (e) {
    ...
    var input_name = $('#bouquet-name').val();
    ...
    var min_size = 0;
    var max_size = 3;
    var input_size = $('#bouquet-size').val();
    ...
    var input_price = $('#bouquet-price').val();
    ...
    var min_season = 0;
    var max_season = 3;
    var input_season = $('#bouquet-season').val();
    ...
    var min_rating = 0;
    var max_rating = 5;
    var input_rating = $('#bouquet-rating').val();
...
__webpack_require__(/*! C:\MAMP\htdocs\boolean\laravel-base-crud\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\MAMP\htdocs\boolean\laravel-base-crud\resources\sass\app.scss */"./resources/sass/app.scss");
